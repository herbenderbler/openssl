...
static const uint8_t decode_0[32] = {
    B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
    B64D_FF, 0xE0, 0xF0, B64D_FF, B64D_FF, 0xF1, B64D_FF, B64D_FF,
    B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
    B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
};
static const uint8_t decode_std_1[32] = {
    B64D_FF, 0xE0, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
    B64D_FF, B64D_FF, 0x3E, B64D_FF, 0xF2, B64D_FF, 0x3F, 0x34,
    0x35, 0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C,
    0x3D, B64D_FF, B64D_FF, B64D_FF, 0x00, B64D_FF, B64D_FF, B64D_FF,
};
static const uint8_t decode_std_2[32] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
    0x18, 0x19, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
};
static const uint8_t decode_std_3[32] = {
    0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21,
    0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29,
    0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31,
    0x32, 0x33, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
};

static const uint8_t decode_srp_1[32] = {
    B64D_FF, 0xE0, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
    B64D_FF, B64D_FF, B64D_FF, B64D_FF, 0xF2, 0x3E, 0x3F, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
    0x09, B64D_FF, B64D_FF, B64D_FF, 0x00, B64D_FF, B64D_FF, B64D_FF,
};
static const uint8_t decode_srp_2[32] = {
    0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11,
    0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19,
    0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21,
    0x22, 0x23, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
};
static const uint8_t decode_srp_3[32] = {
    0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B,
    0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33,
    0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B,
    0x3C, 0x3D, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF, B64D_FF,
};
...
static_assert(sizeof(decode_0) == 32, "decode_0 must be 32 bytes");
static_assert(sizeof(b64d_shuf_sel) == 32, "b64d_shuf_sel must be 32 bytes");
static_assert(sizeof(b64d_dec_shuf) == 32, "b64d_dec_shuf must be 32 bytes");
    ...
    const unsigned char * restrict src, int srclen)
{
    ...
    const uint8_t *input = (const uint8_t *)src;
    int total = 0;
    const __m256i valid_max = _mm256_set1_epi8(63);

    while (srclen >= 64) {
        _mm_prefetch((const char *)(input + 64), _MM_HINT_T0);
        if (decode_one_vector(input, dst, use_srp, valid_max) != 0
            || decode_one_vector(input + 32, dst + 24, use_srp, valid_max) != 0)
            return -1;
        input += 64;
        dst += 48;
        total += 48;
